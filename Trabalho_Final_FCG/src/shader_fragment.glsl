...
*/
    ...
    if(object_id == BUNNY || object_id == CUBE || object_id == GUN || object_id == FACE || /*object_id == PLANE ||*/ object_id == BUNNY)
    {
    ...
    else if (object_id == SPHERE)
    {
        ...
        color.rgb = Kd0 * (lambert + 0.03) + (cos(lambert + M_PI/3)) /*(1 - 0.5*lambert)*/ * texture(TextureImage1, vec2(U,V)).rgb;
